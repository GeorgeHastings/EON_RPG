...
var Moments = {
  ...
  moment15: {
    message: 'You walk through a forest until you cannot see the road. Eventually you come upon a ruined mill.',
    choices: [{
      message: 'Check out the mill',
      link: 17
    }, {
      message: 'Go back to the road',
      link: 18
    }]
  },
  moment16: {
  ...
  moment19: {
    ...
    choices: [{
      message: 'The Arms Shop',
      link: 20
    }, {
      message: 'The General Store',
      link: 21
    }, {
      message: 'The Inn',
      link: 22
    }, {
      message: 'The Town Hall',
      link: 24
    },
		{
			message: 'Leave the town',
			link: 15
		}]
  },
  moment20: {
  ...
  moment23: {
    ...
    inn: 2,
    choices: [{
      message: 'Leave the inn',
      link: 19
    }, {
      message: 'Get another room',
      link: 23
    }]
  },
  moment24: {
    ...
    choices: [{
      message: 'Leave the hall',
      link: 19
    }, {
      message: 'Look around',
      link: 26
    }, {
      message: 'Ask for Jon Peterson',
      link: 26
    }, {
      message: 'Talk to the tenant-in-chief',
      link: 27
    }]
  },
  moment26: {
    message: 'You approach a man writing at a desk near the entrance. "Do you know a man who goes by Jon Peterson?" you ask. "The man points to two men standing near a side entrance."',
    choices: [{
      message: 'Go over',
      link: 27
    }, {
  ...
  moment27: {
    message: 'The men spot you approaching. "Are you Jon Peterson? you ask." He seems to look you over until replying "Yes I am. Would you like to join me for a drink? You look like you could use it."',
    choices: [{
      message: 'Go with him',
      link: 28
    }, {
  ...
  moment28: {
    message: 'You walk outside and turn the corner. The cloaked man with Jon Peterson suddenly pulls a dagger on you and attacks.',
